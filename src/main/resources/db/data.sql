...
INSERT INTO project_tb (member_id, title, category, description, budget_min, budget_max, deadline, bid_filter, project_status, created_at)
VALUES (1, '스타트업 전용 중고 부품 거래 매칭 플랫폼 구축', 'WEB',
        ...
        5000000, 10000000, NOW(), 'ALL', 'OPEN', NOW());
...
VALUES (4, '제조업 불량품 검출용 AI 컴퓨터 비전 모델 개발', 'APP',
        ...
        8000000, 15000000, NOW(), 'ALL', 'OPEN', NOW());
...
VALUES (1, '기업 리브랜딩을 위한 랜딩 페이지 및 UI/UX 디자인 고도화', 'APP',
        ...
        2000000, 4000000, NOW(), 'ALL', 'OPEN', NOW());
