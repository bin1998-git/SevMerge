...
INSERT INTO project_tb (member_id, title, category, description, budget_min, budget_max, deadline, bid_filter, project_status, view_count, created_at)
VALUES (1, '스타트업 전용 중고 부품 거래 매칭 플랫폼 구축', 'WEB',
        ...
        5000000, 10000000, NOW(), 'ALL', 'OPEN', 0,  NOW());

-- 2번 샘플: 딥러닝 기반 이미지 분류 모델 개발 (category: AI_TECH, project_status: RECRUITING)
INSERT INTO project_tb (member_id, title, category, description, budget_min, budget_max, deadline, bid_filter, project_status, view_count, created_at)
VALUES (4, '제조업 불량품 검출용 AI 컴퓨터 비전 모델 개발', 'APP',
        ...
        8000000, 15000000, NOW(), 'ALL', 'OPEN', 0, NOW());
...
VALUES (1, '기업 리브랜딩을 위한 랜딩 페이지 및 UI/UX 디자인 고도화', 'APP',
        ...
        2000000, 4000000, NOW(), 'ALL', 'OPEN', 0, NOW());
...
-- Review 샘플데이터
INSERT INTO review_tb (expert_profile_id, member_id, count_star, content, created_at)
VALUES (1, 1, 5, '정말 꼼꼼하고 빠르게 작업해 주셨어요. 요구사항을 잘 이해하고 결과물도 깔끔했습니다.', NOW());

INSERT INTO review_tb (expert_profile_id, member_id, count_star, content, created_at)
VALUES (1, 4, 4, '소통이 원활하고 일정도 잘 지켜주셨습니다. 다음에도 함께하고 싶어요.', NOW());

INSERT INTO review_tb (expert_profile_id, member_id, count_star, content, created_at)
VALUES (1, 1, 5, '기술적으로 매우 뛰어나신 분입니다. 복잡한 작업도 깔끔하게 처리해 주셨어요.', NOW());
