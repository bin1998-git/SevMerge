...
이학산 — 2026-06-23 오후 3:43
전달됨
이미지
#5_2조_깃훅  •  화요일
이상현 [텍스쳐],  — 2026-06-24 오전 11:32
{{> layout/header}}
...
message.txt
57KB
이학산 — 2026-06-24 오후 12:49
일단 이거 전체 바꿨는데 숙련전문가 뱃지는 어떡할까요
이미지
이상현 [텍스쳐],  — 2026-06-24 오후 12:50
뱃지 만들어야되는데
이학산 — 2026-06-24 오후 12:50
만들게욤
최원종 [쭈욱],  — 어제 오전 11:41
관리자 수익관리도메인 만들었고 광고신청 거절할 때 거절사유입력 및  알림발송 추가했습니다
이학산 — 어제 오후 12:05
관리자
그래프 총 회원수 점점 증가 하도록 수정
최근 가입 회원
박효균 — 어제 오후 12:53
<관리자>

전체 일반회원 / 전체 전문가 / 전체 프로젝트 / 광고수익
최근 가입한 회원 No 는 최근 가입한 회원이 1페이지 상단으로 등록
제휴문의관리 대시보드 삭제 / 제휴문의 는 있어야함 (회사 메일로 보내는 로직)
1:1 문의 키워드 검색 안됨
공지사항관리 키워드 검색 안됨
댓글 신고 문제 ( 댓글 신고를 할 경우 신고내역과 해당 댓글이 일치하는지 검증하는 과정이 필요하고, 검증이 된 대상은 계정 전체 차단이 아닌 부분 차단(커뮤니티제한 등)을 고려해서 해야함
등급별 관리자 관리 대시보드 제거
수익현황은



결제취소시 에스크로에서 포인트를 돌려받
출금요청관리 (관리자 - 전문가)
